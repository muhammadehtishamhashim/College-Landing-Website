                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                                className: "font-bold text-green-400 text-sm sm:text-base md:text-lg lg:text-xl transition-colors duration-200 group-hover:text-white",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "sm:hidden",
                                                        children: "FG"
...
;
;
const OptimizedDarkVeil = ({ hueShift = 0, noiseIntensity = 0, scanlineIntensity = 0, speed = 0.5, scanlineFrequency = 0, warpAmount = 0, resolutionScale = 0.5 })=>{
    ...
    const gradientColors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>[
            `hsl(${120 + hueShift}, 70%, 20%)`,
            `hsl(${240 + hueShift}, 70%, 15%)`,
            `hsl(${180 + hueShift}, 60%, 10%)`,
            'rgba(0, 0, 0, 0.8)'
        ], [
        hueShift
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const resize = ()=>{
            ...
            const width = Math.floor(rect.width * resolutionScale);
            const height = Math.floor(rect.height * resolutionScale);
            canvas.width = width;
        ...
        const drawFrame = ()=>{
            ...
            const gradient = ctx.createRadialGradient(width * (0.3 + Math.sin(time * 0.001) * 0.1), height * (0.4 + Math.cos(time * 0.0015) * 0.1), 0, width * 0.6, height * 0.6, Math.max(width, height) * 0.8);
            ...
            ctx.fillRect(0, 0, width, height);
            // Add subtle warp effect
            if (warpAmount > 0) {
                const imageData = ctx.getImageData(0, 0, width, height);
                const data = imageData.data;
                // Simple warp effect (optimized)
                for(let y = 0; y < height; y += 4){
                    for(let x = 0; x < width; x += 4){
                        const index = (y * width + x) * 4;
                        const warpX = Math.sin(y * 0.01 + time * 0.001) * warpAmount * 2;
                        const warpY = Math.cos(x * 0.01 + time * 0.001) * warpAmount * 2;
                        if (index < data.length - 4) {
                            data[index] = Math.min(255, data[index] + warpX);
                            data[index + 1] = Math.min(255, data[index + 1] + warpY);
                        }
                    }
                }
            ...
            if (scanlineIntensity > 0 && scanlineFrequency > 0) {
                ctx.globalAlpha = scanlineIntensity * 0.3;
                ctx.strokeStyle = 'rgba(0, 255, 0, 0.1)';
                ctx.lineWidth = 1;
                for(let y = 0; y < height; y += scanlineFrequency * 10){
                    ctx.beginPath();
                    ctx.moveTo(0, y);
                    ctx.lineTo(width, y);
                    ctx.stroke();
        ...
        const animate = (timestamp)=>{
            timeRef.current = timestamp * speed;
            drawFrame();
...
const __TURBOPACK__default__export__ = OptimizedDarkVeil;
}),
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(DarkVeil, {
                    hueShift: 0,
                    noiseIntensity: 0,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__01cbbba1._.js.map