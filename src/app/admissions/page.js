        ...
        <section className="py-20 bg-gray-900 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="animated-border-box group/timeline transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-blue-900/20">
              ...
              <div className="timeline-content bg-gray-800 rounded-2xl shadow-lg overflow-hidden p-8 relative">
                {/* Subtle background animation on hover */}
                <div className="absolute inset-0 bg-gradient-to-br from-blue-900/10 to-purple-900/10 opacity-0 group-hover/timeline:opacity-100 transition-opacity duration-500 rounded-2xl"></div>
        ...
        <section className="bg-gray-800 py-20 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="animated-border-box group/procedures transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-purple-900/20">
              ...
              <div className="procedures-content bg-gray-900 rounded-2xl shadow-lg overflow-hidden p-8 relative">
                {/* Subtle background animation on hover */}
                <div className="absolute inset-0 bg-gradient-to-br from-purple-900/10 to-pink-900/10 opacity-0 group-hover/procedures:opacity-100 transition-opacity duration-500 rounded-2xl"></div>
        ...
        <section className="py-20 bg-gray-900 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <div className="animated-border-box group/apply transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-green-900/20">
              ...
              <div className="apply-content bg-gray-800 rounded-2xl shadow-lg overflow-hidden p-12 text-center relative">
                {/* Subtle background animation on hover */}
                <div className="absolute inset-0 bg-gradient-to-br from-green-900/10 to-blue-900/10 opacity-0 group-hover/apply:opacity-100 transition-opacity duration-500 rounded-2xl"></div>

                <div className="relative z-10">
                  <h2 className="text-3xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">Ready to Apply?</h2>
                  <p className="text-xl mb-8 text-gray-300">
                    Take the first step towards your future in science and technology.
                  </p>
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <button className="group/btn relative bg-gradient-to-r from-green-500 to-blue-500 text-white font-semibold px-8 py-4 rounded-xl overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-green-500/30">
                    ...
                    <button className="group/btn relative bg-gray-700 text-white font-semibold px-8 py-4 rounded-xl border border-gray-600 overflow-hidden transition-all duration-300 hover:scale-105 hover:bg-gray-600 hover:border-gray-500">
